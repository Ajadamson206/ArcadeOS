 ...
 */
extern void *memmove(void *dst, const void *src, unsigned long num);
...
/**
 * Sets the first num bytes of the block of memory pointed by ptr to the specified 
 * value (interpreted as an u16).
 */
extern void *memset16(void *ptr, int value, unsigned long num_bytes);

/**
 * Sets the first num bytes of the block of memory pointed by ptr to the specified 
 * value (interpreted as an integer).
 */
extern void *memset32(void *ptr, int value, unsigned long num_bytes);
